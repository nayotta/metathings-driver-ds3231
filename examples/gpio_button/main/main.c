...
void example_short_press_callback() { printf("example_short_press\n"); }

void example_long_press_callback() { printf("example_long_press\n"); }
...
void app_main() {
  ...
  gpio_btn_handle->mt_gpio_btn_short_press_callback =
      example_short_press_callback;
  gpio_btn_handle->mt_gpio_btn_long_press_callback =
      example_long_press_callback;
